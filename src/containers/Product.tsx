...
const Product: FC<PageCollection2Props> = ({ className = "" }) => {
  ...
  let productNameDecoded: any = atob(productName);
  ...
  const data: any = useSelector((state: any) =>
    productNameDecoded === "Flash Sale"
      ? state.products.saleItems
      : state.products.newArrivalProducts
  );
  ...
  let subCategoryNameDecoded: any = myQueryParam;
  ...
  useEffect(() => {
    if (productNameDecoded === "Flash Sale") {
      getSaleItems();
    } else {
    ...
    setSideBarFilters({ subCategories: subCategories });
  }, [loginToken, limit, productNameDecoded]);
            ...
            <div className="space-y-10 lg:space-y-14">
              ...
              <div className="max-w-screen-sm">
                <h2 className="block text-2xl sm:text-3xl lg:text-4xl font-semibold">
                  {productNameDecoded ? productNameDecoded : "Loading..."}
                </h2>
                          ...
                          {(data?.length >= limit ||
                            ...
                            <div style={{ display: "block" }}>
                              <div className="flex justify-center items-center mt-10 mb-12">
                                <ButtonPrimary
                                  // loading={categoryLoader === true ? true : false}
                                  onClick={() => {
                                    showMeMore(limit + 6);
                                  }}
                                >
