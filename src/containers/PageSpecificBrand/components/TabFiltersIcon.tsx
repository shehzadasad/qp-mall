...
//
export interface TabFiltersIconProps {
  className?: string;
  categories?: any;
}
const TabFiltersIcon = ({ categories = [] }) => {
    ...
    return (
      <div className="flex-shrink-0">
        ...
        >
          ...
          <span className="ml-2 hidden md:block ">Products filters (3)</span>
          {renderXClear()}
        </div>
